...
Phase 4 support for `moes`, conditional. Apply when the diff accepts untrusted input, parses files, builds commands/queries/URLs, renders rich output, redirects users, or handles uploads/downloads.
