...
Phase 4 support for `moes`, conditional. Apply when the diff adds or changes HTTP APIs, RPC endpoints, webhooks, or machine-consumable request/response surfaces.
