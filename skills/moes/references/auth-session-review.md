...
Phase 4 support for `moes`, conditional. Apply when the diff touches authentication, sessions, cookies, tokens, logout, password reset, MFA, account recovery, or authorization boundaries.
