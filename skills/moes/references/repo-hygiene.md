...
Phase 4 support for `moes`, conditional. Apply when the diff changes dependency manifests, lockfiles, release config, action references, security policy files, or other repo-level trust surfaces.
