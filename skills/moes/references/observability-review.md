...
Phase 4 and Phase 6 support for `moes`, conditional. Apply when the diff changes logging, tracing, audit events, alerts, error reporting, or sensitive state transitions that must be diagnosable.
