...
Applies to the changed PHP code in `moes` Phase 1 (the diff, not the whole repo). The Phase-0 project context capsule and standing project instructions always override these generic rules.
