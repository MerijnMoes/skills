...
Layer 1-2 variant-specific params on top: palette selection (`steps` with named options), temperature warmth, or tint vs. true color. See `references/design-studio/reference/live.md` for the full params contract.
