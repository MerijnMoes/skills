...
See `references/design-studio/reference/live.md` for the full params contract.
...
The tactical selection procedure and the reflex-reject list live in [references/design-studio/reference/brand.md](brand.md) under **Font selection procedure** and **Reflex-reject list** (loaded for brand-register tasks). The rest of this section covers the adjacent knowledge: anti-reflex corrections, system font use, and pairing rules.
